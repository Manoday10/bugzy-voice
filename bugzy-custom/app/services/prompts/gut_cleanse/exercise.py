...
- Health Conditions: {state.get('health_conditions') or 'None'}
- Daily Posture: {state.get('workout_posture_gut', 'Not provided')}
- Hydration Habits: {state.get('workout_hydration_gut', 'Not provided')}
- Gut Mobility Practices: {state.get('workout_gut_mobility_gut', 'Not provided')}
- Relaxation Methods: {state.get('workout_relaxation_gut', 'Not provided')}
- Gut Awareness: {state.get('workout_gut_awareness_gut', 'Not provided')}
...
**Intensity:** [Low/Medium] (Focus on Movement & Gut Health)
