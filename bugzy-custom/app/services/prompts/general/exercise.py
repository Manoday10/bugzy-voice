...
- Goals: {state['exercise_goals']}
- Equipment: {state.get('equipment', 'None/Bodyweight')}
...
"""
    ...
    try:
        ...
        search_query = f"{focus} {state['fitness_level']} workout exercises"
